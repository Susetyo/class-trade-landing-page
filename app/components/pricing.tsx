...
export function Pricing() {
  return (
    <section id="pricing" className="relative z-10 px-4 py-10 md:px-8 md:py-20">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[34px] border border-[#E4DDCE] bg-white p-3 shadow-[0_24px_70px_rgba(28,37,19,0.1)] sm:p-5 md:rounded-[48px] md:p-10">
        <div className="rounded-[28px] bg-[#FBF8F1] p-5 text-[#102016] sm:p-6 md:rounded-[40px] md:p-10 lg:p-14">
...
function PlanCard({
  ...
  return (
    <article className="flex min-h-[420px] min-w-0 snap-center flex-col rounded-[28px] bg-[#102016] p-5 text-[#F8F4EC] shadow-[0_18px_50px_rgba(28,37,19,0.18)] md:min-h-[460px] md:rounded-[32px] md:p-7">
      {badge ? (
      ...
      <div>
        <h3 className="text-2xl font-semibold leading-tight md:text-3xl">{name}</h3>
        <p className="mt-2 text-base leading-7 text-[#D5D1C5] md:text-lg">{description}</p>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-1 flex flex-wrap items-end gap-2">
          <p className="text-5xl font-semibold leading-none md:text-6xl">{price}</p>
          <p className="pb-2 text-base font-medium text-[#B7B29F]">/ batch</p>
        </div>
      </div>
